...
# y_true = np.array([7, 5, 2, 0, 7, 9, 1, 3, 1, 7, 0, 4, 2, 8, 8, 5, 9, 1, 7, 6, 4, 9, 3, 4, 6, 0, 0, 4, 2, 8, 4, 4])
# y_pred = np.array([7, 5, 2, 3, 7, 9, 1, 3, 1, 7, 0, 4, 2, 8, 8, 5, 9, 1, 7, 6, 4, 9, 3, 4, 6, 0, 0, 4, 2, 8, 4, 4])
# y_conf = np.array([3.3711605072021484, 3.0010221004486084, 3.355598211288452, 1.497674822807312, 3.3612592220306396, 2.396988868713379, 2.318349838256836, 2.4060187339782715, 2.345181941986084, 3.407022476196289, 3.3474624156951904, 2.2371909618377686, 3.263763189315796, 3.1516318321228027, 3.1735641956329346, 2.848693609237671, 1.8630481958389282, 2.0069398880004883, 3.4147942066192627, 3.5103237628936768, 2.808281183242798, 2.381640672683716, 2.4887619018554688, 2.7494890689849854, 3.299596071243286, 3.0244572162628174, 2.9500067234039307, 2.6996641159057617, 1.9644535779953003, 3.2420568466186523, 2.286465644836426, 2.083435535430908])
#
# norm = np.linalg.norm(y_conf)
# normal_array = y_conf/norm
# print(normal_array)
# reliability_diagram(y_true, y_pred, normal_array, num_bins=10, draw_ece=True,
#                           draw_bin_importance="alpha", draw_averages=True,
#                           title="test", figsize=(6, 6), dpi=100,
#                           return_fig=True)